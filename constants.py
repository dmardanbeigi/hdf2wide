...
#    ('BLOCK', str, 6),
    ...
    ('latency_correction', np.float32),
    ('poly_type', str, 32),
    ('win_select_func', str, 6),
    ('cal_point_set', np.uint8),
...
win_sizes_config=dict()
win_sizes_config['eyefollower'] = (3,1)
win_sizes_config['eyelink'] = (33,8)
win_sizes_config['eyetribe'] = (2,1)
win_sizes_config['hispeed1250'] = (41,10)
win_sizes_config['hispeed240'] = (9,2)
win_sizes_config['red250'] = (9,2)
win_sizes_config['red500'] = (17,4)
win_sizes_config['redm'] = (5,1)
win_sizes_config['t60xl'] = (3,1)
win_sizes_config['tx300'] = (11,3)
win_sizes_config['x2'] = (3,1)
